...
type ToolsConfig struct {
	...
	AllowSafePaths  []string           `json:"allow_safe_paths"  env:"PICOCLAW_TOOLS_ALLOW_SAFE_PATHS"`
	...
	ReadImage       ToolConfig         `json:"read_image"                                               envPrefix:"PICOCLAW_TOOLS_READ_IMAGE_"`
